...
class AutoEncoder():
    ...
    def __init__(self, input_dim):
        ...
        #PROVA 1: LAYER DI 16 NEURONI
        layer = Dense(32, activation='selu', kernel_initializer=initializers.RandomNormal )( input_layer )
        layer = Dense( 16, activation='selu', kernel_initializer=initializers.RandomNormal )( layer )
        #layer = Dense( 8, activation='selu', kernel_initializer=initializers.RandomNormal )( layer )
        layer = Dense( 8, activation='selu', kernel_initializer=initializers.RandomNormal )( layer )
        #layer = Dense( 8, activation='selu', kernel_initializer=initializers.RandomNormal )( layer )
        layer = Dense( 16, activation='selu', kernel_initializer=initializers.RandomNormal )( layer )
        layer = Dense( 32, activation='selu', kernel_initializer=initializers.RandomNormal )( layer )
        output_layer= Dense(input_dim, activation='selu',kernel_initializer=initializers.RandomNormal)(layer)
