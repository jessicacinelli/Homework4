...
def transformData ( training, training_ae,  validation, test ):
     ...
     dfTrainAe = pd.read_csv(training_ae, names=names, header=None, sep=',', index_col=False, dtype='unicode')
     ...
     return x_train, y_train, L_train, x_train_ae, y_train_ae, L_train_ae, x_val, y_val, L_val, x_test, y_test, L_test
